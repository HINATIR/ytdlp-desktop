...
Public Class Form2
    ...
    Private Sub Form2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If IO.File.Exists("folder.txt") Then

            Dim sr As New StreamReader("folder.txt", Encoding.GetEncoding("utf-8"))
    ...
    Private Sub Form2_FormClosing(sender As Object, e As EventArgs) Handles MyBase.FormClosing
        Dim sw As New StreamWriter("folder.txt", False,
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If (ComboBox2.SelectedIndex = -1) Then
            ...
            Return
        End If
        Dim DL As New ProcessStartInfo With {.FileName = Environment.GetEnvironmentVariable("ComSpec"), .WindowStyle = ProcessWindowStyle.Normal, .Arguments = "/c yt-dlp " + TextBox3.Text + TextBox1.Text
        }
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        'サムネDL
        If (ComboBox2.Text = "サムネをダウンロード") Then
            TextBox3.Text = TextBox3.Text + "--write-thumbnail --skip-download --convert-thumbnails png "
        Else
            '秒数指定
            If (TextBox6.Text <> "" And TextBox7.Text <> "") Then
                TextBox3.Text = TextBox3.Text + "--download-sections *" + TextBox6.Text + "-" + TextBox7.Text + " "
            ElseIf (TextBox6.Text = "" Or TextBox7.Text = "") Then
                If (TextBox6.Text = "" And TextBox7.Text = "") Then
        ...
        Dim DL As New ProcessStartInfo With {.FileName = Environment.GetEnvironmentVariable("ComSpec"), .WindowStyle = ProcessWindowStyle.Normal, .Arguments = "/c yt-dlp --cookies-from-browser " + ComboBox3.Text + " " + TextBox3.Text + TextBox1.Text
        }
        Dim p1 As Process = Process.Start(DL)
        TextBox3.Text = ""
    End Sub
